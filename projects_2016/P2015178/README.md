...
##Συμπεράσματα:
  ...
  Το Math Snake, είναι ένα παιχνίδι, το οποίο μπορεί να αποτελέσει ένα βοήθημα-εργαλείο στα χέρια των εκπαιδευτών, καθώς με τρόπο ευχάριστο προτρέπει τους μαθητές να υπολογίσουν εξισώσεις. Το παιχνίδι είναι εύκολο στον χειρισμό, απλό, 
