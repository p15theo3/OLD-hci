...
**Κεφάλαιο 1.23 :** Προβλήματα με πρόσθεση και αφαίρεση κλασμάτων.

**Κεφάλαιο 1.8 :** Πράξεις με μεικτές αριθμητικές παραστάσεις.

**Μέρος Ά - Κεφαλαιο 7ο : Θετικοί και Αρνητικοί αριθμοί (Ά Γυμνασίου)**
