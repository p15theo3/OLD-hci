...
* Μόλις ο χρήστης βρεθεί σε ένα από τα επιλεγμένα σημεία (υπολογίζοντας την απόσταση του χρήστη από το αποθηκευμένο σημείο πάνω στο χάρτη) τότε εμφανίζεται μια ερώτηση σε σχέση με το σημείο αυτό, καθώς και μια φωτογραφία του σημείου αυτού.
