...
Μπορείτε να δείτε παλιότερες εργασίες συμφοιτητών σας στα αντίστοιχα branch αυτού του repository. Ειδικότερα στο φάκελο Π2014221 υπάρχει μια παλιότερη εργασία την οποία μπορείτε να έχετε σαν πρότυπο για τη δική σας εργασία. Αφού επιλέξετε το README.md αρχείο που υπάρχει μέσα στο φάκελο Π2014221 (online από το github.com) κάντε κλικ πάνω στο κουμπάκι με το μολύβι (edit) που βρίσκεται πάνω δεξιά για να πάρετε ιδέες ως προς την συγγραφή π.χ. πως προσθέτουμε εικόνες στο αρχείο README.md. Επίσης με το Preview changes που βρίσκεται πάνω αριστερά μπορείτε να δείτε πως θα φαίνεται το αρχείο σας README.md πριν γίνει το commit changes για την δική σας εργασία.
