...
####Α.Μ.: Π2015077
####Webmail Ιονίου: p15tria@ionio.gr
####Κέρκυρα, 2017
...
##Σύνοψη
  ...
  Στα πλαίσια του μαθήματος Επικοινωνία Ανθρώπου υπολογιστή επέλεξα τη δημιουργία ενός εκπαιδευτικού κλασσικού βιντεο-παιχνιδιού με το εργαλείο Scratch, το οποίο είναι το FlappyBird (Math Edition). Στο παιχνίδι FlappyBird (Math Edition), το οποίο βασίζεται στο κλασσικό βιντεο-παιχνίδι Flappy Bird, παρουσιάζονται βασικές έννοιες των μαθηματικών, (πρόσθεση, αφαίρεση, πολλαπλασιασμός, διαίρεση), όπου ο παίκτης μαθαίνει ή και εξασκεί τις παραπάνω ένοιες με ποιο ευχάριστο τρόπο.
...
##Διαδικασία Ανάπτυξης
  ...
  Μετά από μια σειρά διαλέξεων στο μάθημα Επικοινωνία- Ανθρώπου Υπολογιστή απέκτησα σημαντική βοήθεια για τις επιλογές για τη δημιουργία του εκπαιδευτικού παιχνιδιού FlappyBird (Math Edition). Αρχικά, ξεκίνησα με την ιδέα ενός άλλου παιχνιδιού, το οποίο δε φαίνεται στο github, αλλά με βοήθεια των βοηθών του μαθήματος και τις ενημερώσεις του καθηγητή στο μάθημα κατέληξα στο παιχνίδι που έκανα.
Επιπλέον, χάρη στη λίστα στο Scratch, από το καθηγητή, που περιείχε μια συλλογή από κλασσικά βιντεο-παιχνίδια, υλοποιημένα στο Scratch, διευκόλυνε την αναζήτηση μου για εύρεση κλασσικού βιντεο-παιχνιδιού. Έτσι στη συνέχεια

##Διάγραμμα Λειτουργίας Συστήματος

  Το παιχνίδι FlappyBird (Math Edition) έχει ως σκοπό την υλοποίηση των μαθηματικών ερωτήσεων και της απόκτησης της δυνατόν υψηλότερης βαθμολογίας. Στα κενά κάθε σωλήνα περιέχεται ένας αριθμός και ένα κενό στον άλλον. Ο αριθμός που εμφανίζεται είναι τυχαίος με τέτοιο τρόπο ώστε οι εμφανίσεις των αριθμών να μην είναι εύκολα προβλεπόμενοι (το ίδιο και για τις εμφανίσεις των σωλήνων). Σε περίπτωση που ο αριθμός που δίνεται δεν είναι σωστός ο παίκτης, προφανώς, θα πρέπει να ακολουθήσει την άλλη διαδρομή για να πάρει τον πόντο του. ‘Έτσι δίνεται η δυνατότητα στο παίκτη να ασκήσει τη κριτική ικανότητά του ελέγχοντας εάν ο αριθμός που του δόθηκε είναι χρήσιμος για τη πράξη που καλείται να λύσει. Εάν απαντήσει σωστά στη πράξη επιλέγοντάς τον αριθμό που είναι σωστός για την πράξη τότε ο αριθμός θα εμφανιστεί ως πράσινος δείχνοντας στο χρήστη ότι η επιλογή που έκανε ήταν σωστή.

###Διαχείριση του λάθους
  Σε περίπτωση που ο χρήστης απαντήσει λάθος στη πράξη και επιλέξει τον αριθμό τότε ο αριθμός θα παίρνει το χρώμα κόκκινο για να δείξει στο χρήστη ότι απάντησε λάθος. Επιπλέον, δε δέχεται ο παίκτης κάποια τιμωρία όπως μείωση της βαθμολογίας του.
  Στη περίπτωση που επιλέξει το μονοπάτι που δεν είναι αριθμός και η επιλογή αυτή δεν είναι σωστή τότε πάλι ο παίκτης δε δέχεται κάποιου είδους τιμωρία.

  Σε περίπτωση που ο χρήστης ακουμπήσει τους σωλήνες ή το έδαφος εμφανίζεται ένα μύνημα στο παίκτη που του λέει να ξαναπροσπαθήσει.
Ακόμα, εάν ο χρήστης αφήσει το παιχνίδι χωρίς να κάνει κάποια κίνηση στο παιχνίδι τότε μετά από ένα σημείο, και συγκεκριμένα μετά από τέσσσερα deaths, σταματάει το παιχνίδ δηλαδή κάνει παύση και ζητά από το χρήστη να πατήσει ένα κουμπί play για να συνεχέσει από εκαί που έμεινε. Τέλος, όταν τελειώσει ο παίκτης όλες τις πίστες που απαιτείται από το παιχνίδι τότε εμφανίζεται στην οθόνη του ένα αντίστοιχο μήνυμα σε εικόνα.
...
###Στο τέλος του γύρου, πράξης π.χ. πρόσθεση, ο παίκτης μαζεύει τη κατηγορία του
