...
Στο πάνω αριστερά σημείο της οθόνης φαίνεται το χρώμα της επόμενης λωρίδας προς την οποία πρέπει να κατευθυνθεί ο παίκτης καθώς και το χρονόμετρο. Πάνω δεξιά στην οθόνη αναγράφεται η τωρινή κατεύθυνση του αμαξιού και η ταχύτητά του, την οποία μπορεί να αλλάξει ο χρήστης με το slider.
