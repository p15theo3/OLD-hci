...
* Το πρώτο Snake (Snake 2) εμφανίζεται στο κέντρο της οθόνης και τρώει μόνο τα φρούτα των οποίων οι τιμές είναι πολλαπλάσια του 2. Αφού το Snake 2 φάει όλα τα πολλαπλάσια του 2, εξαφανίζεται. 

![Snake2](https://cloud.githubusercontent.com/assets/22655733/20869389/26108f40-ba7a-11e6-898a-e6a968001b4c.JPG)

* Εμφανίζεται το Snake 3 (κέντρο οθόνης), που τρώει μόνο τα φρούτα με τιμές πολλαπλάσια του 3. Όταν φαγωθούν τα παραπάνω 
...
* Εμφανίζεται το Snake 5 (κέντρο οθόνης), που τρώει μόνο τα φρούτα με τιμές πολλαπλάσια του 5. Όταν φαγωθούν τα παραπάνω φρούτα, το Snake 5 εξαφανίζεται.

![Snake5](https://cloud.githubusercontent.com/assets/22655733/20869418/9e4ac80e-ba7a-11e6-85f9-3986fb5d98e4.JPG)

* Εμφανίζεται, τέλος, το Snake 7 (κέντρο οθόνης), που τρώει μόνο τα φρούτα με τιμές πολλαπλάσια του 7. Όταν φαγωθούν τα παραπάνω φρούτα, το Snake 7 εξαφανίζεται.
